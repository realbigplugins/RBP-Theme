            ...
            front: {
                files: {
                    'script.js': [
                        ...
                        'assets/vendor/js/foundation/foundation.core.js',
                        'assets/vendor/js/foundation/foundation.util.keyboard.js',
                        'assets/vendor/js/foundation/foundation.util.box.js',
                        'assets/vendor/js/foundation/foundation.util.nest.js',
                        'assets/vendor/js/foundation/foundation.util.mediaQuery.js',
                        'assets/vendor/js/foundation/foundation.util.triggers.js',
                        'assets/vendor/js/foundation/foundation.util.motion.js',
